...
COMMIT;
-- Create trigger to update LastModified date for Customers table
...
END;
/
-- Create trigger to log transactions into AuditLog table
...
START WITH 1
INCREMENT BY 1;
-- Create trigger to enforce business rules on transactions
